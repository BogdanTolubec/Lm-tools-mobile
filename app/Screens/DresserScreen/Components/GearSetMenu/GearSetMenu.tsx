...
type Props = {
    title: string | null,
    gearSet: gearSet,
    //gearSetsCount: number,
    //setGearSetsCount: React.Dispatch<React.SetStateAction<number>>
}

function GearSetMenu({gearSet, title, /*gearSetsCount, setGearSetsCount*/}: Props): React.JSX.Element {
